...
3. Troque o número de versão `?v=2026061502` no `index.html`, por exemplo para `?v=20260616`, nos arquivos `styles.css`, `main.js`, `lib/manifest.js`, `lib/gsap.min.js` e `lib/ScrollTrigger.min.js`.
